...
class controller extends model
{
    public function __construct()
    {
         ...
         if (isset($_POST["addabout"]))
        {
            ...
            $path = "uploads/users/" . $_FILES["video"]["tmp_name"];
       ...
       $shwaboutdata=$this->shwaboutdata('add_about');
        ...
        $shwdata=$this->shwdata('add_deal');
         ...
         {
            $tmp_name1 = $_FILES["photo1"]["tmp_name1"];
            $path1 = "uploads/users/" . $_FILES["photo1"]["tmp_name1"];
            move_uploaded_file($tmp_name1, $path1);
            $nm1 = $_POST["nm1"];
           
            $tmp_name2 = $_FILES["photo2"]["tmp_name2"];
            $path2 = "uploads/users/" . $_FILES["photo2"]["tmp_name2"];
            move_uploaded_file($tmp_name2, $path2);
            $nm2 = $_POST["nm2"];

            $tmp_name3 = $_FILES["photo3"]["tmp_name3"];
            $path3 = "uploads/users/" . $_FILES["photo3"]["tmp_name3"];
            move_uploaded_file($tmp_name3, $path3);
            $nm3 = $_POST["nm3"];
       ...
       {
        $tmp_name1 = $_FILES["img1"]["tmp_name1"];
        $path1 = "uploads/users/" . $_FILES["img1"]["tmp_name1"];
        move_uploaded_file($tmp_name1, $path1);
        $pr1 = $_POST["pr1"];

        $tmp_name2 = $_FILES["img2"]["tmp_name2"];
        $path2 = "uploads/users/" . $_FILES["img2"]["tmp_name2"];
        move_uploaded_file($tmp_name2, $path2);
        $pr2 = $_POST["pr2"];

        $tmp_name3 = $_FILES["img3"]["tmp_name3"];
        $path3 = "uploads/users/" . $_FILES["img3"]["tmp_name3"];
        move_uploaded_file($tmp_name3, $path3);
        $pr3 = $_POST["pr3"];

        $tmp_name4 = $_FILES["img4"]["tmp_name4"];
        $path4 = "uploads/users/" . $_FILES["img4"]["tmp_name4"];
        move_uploaded_file($tmp_name4, $path4);
        $pr4 = $_POST["pr4"];

        $tmp_name5 = $_FILES["img5"]["tmp_name5"];
        $path5 = "uploads/users/" . $_FILES["img5"]["tmp_name5"];
        move_uploaded_file($tmp_name5, $path5);
        $pr5 = $_POST["pr5"];

        $tmp_name6 = $_FILES["img6"]["tmp_name6"];
        $path6 = "uploads/users/" . $_FILES["img6"]["tmp_name6"];
        move_uploaded_file($tmp_name6, $path6);
        $pr6 = $_POST["pr6"];

        $tmp_name7 = $_FILES["img7"]["tmp_name7"];
        $path7 = "uploads/users/" . $_FILES["img7"]["tmp_name7"];
        move_uploaded_file($tmp_name7, $path7);
        $pr7 = $_POST["pr7"];

        $tmp_name8 = $_FILES["img8"]["tmp_name8"];
        $path8 = "uploads/users/" . $_FILES["img8"]["tmp_name8"];
        move_uploaded_file($tmp_name8, $path8);
        $pr8 = $_POST["pr8"];

        $tmp_name9 = $_FILES["img9"]["tmp_name9"];
        $path9 = "uploads/users/" . $_FILES["img9"]["tmp_name9"];
        move_uploaded_file($tmp_name9, $path9);
        $pr9 = $_POST["pr9"];

        $tmp_name10 = $_FILES["img10"]["tmp_name10"];
        $path10 = "uploads/users/" . $_FILES["img10"]["tmp_name10"];
        move_uploaded_file($tmp_name10, $path10);
        $pr10 = $_POST["pr10"];

        $tmp_name11 = $_FILES["img11"]["tmp_name11"];
        $path11 = "uploads/users/" . $_FILES["img11"]["tmp_name11"];
        move_uploaded_file($tmp_name11, $path11);
        $pr11 = $_POST["pr11"];

        $tmp_name12 = $_FILES["img12"]["tmp_name12"];
        $path12 = "uploads/users/" . $_FILES["img12"]["tmp_name12"];
    ...
    $shwslidedata=$this->shwslidedata('add_slider');
     ...
     {
        $tmp_name1 = $_FILES["pc1"]["tmp_name1"];
        $path1 = "uploads/users/" . $_FILES["pc1"]["tmp_name1"];
        move_uploaded_file($tmp_name1, $path1);
        $dtl1 = $_POST["dtl1"];

        $tmp_name2 = $_FILES["pc2"]["tmp_name2"];
        $path2 = "uploads/users/" . $_FILES["pc2"]["tmp_name2"];
        move_uploaded_file($tmp_name2, $path2);
        $dtl2 = $_POST["dtl2"];

        $tmp_name3 = $_FILES["pc3"]["tmp_name3"];
        $path3 = "uploads/users/" . $_FILES["pc3"]["tmp_name3"];
        move_uploaded_file($tmp_name3, $path3);
        $dtl3 = $_POST["dtl3"];

        $tmp_name4 = $_FILES["pc4"]["tmp_name4"];
        $path4 = "uploads/users/" . $_FILES["pc4"]["tmp_name4"];
        move_uploaded_file($tmp_name4, $path4);
        $dtl4 = $_POST["dtl4"];

        $tmp_name5 = $_FILES["pc5"]["tmp_name5"];
        $path5 = "uploads/users/" . $_FILES["pc5"]["tmp_name5"];
        move_uploaded_file($tmp_name5, $path5);
        $dtl5 = $_POST["dtl5"];

        $tmp_name6 = $_FILES["pc6"]["tmp_name6"];
        $path6 = "uploads/users/" . $_FILES["pc6"]["tmp_name6"];
        move_uploaded_file($tmp_name6, $path6);
        $dtl6 = $_POST["dtl6"];
        
        $tmp_name7 = $_FILES["pc7"]["tmp_name7"];
        $path7 = "uploads/users/" . $_FILES["pc7"]["tmp_name7"];
        move_uploaded_file($tmp_name7, $path7);
        $dtl7 = $_POST["dtl7"];

        $tmp_name8 = $_FILES["pc8"]["tmp_name8"];
        $path8 = "uploads/users/" . $_FILES["pc8"]["tmp_name8"];
        move_uploaded_file($tmp_name8, $path8);
        $dtl8 = $_POST["dtl8"];

        $data = array("pc1" => $path1, "dtl1" => $dtl1,"pc2" => $path2, "dtl2" => $dtl2,"pc3" => $path3, "dtl3" => $dtl3,"pc4" => $path4, "dtl4" => $dtl4,"pc5" => $path5, "dtl5" => $dtl5,"pc6" => $path6, "dtl6" => $dtl6,"p7" => $path7, "dtl7" => $dtl7,"pc8" => $path8, "dtl8" => $dtl8 );
    ...
    $shwgallarydata=$this->shwgallarydata('add_gallary');
     ...
     if (isset($_POST["addfooter"])) 
     {
        ...
        $tmp_name1 = $_FILES["pht1"]["tmp_name1"];
        $path1 = "uploads/users/" . $_FILES["pht1"]["tmp_name1"];
        move_uploaded_file($tmp_name1, $path1);
        
        $phtdt1 = $_POST["phtdt1"];
        
        $tmp_name2 = $_FILES["pht2"]["tmp_name2"];
        $path2 = "uploads/users/" . $_FILES["pht2"]["tmp_name2"];
        move_uploaded_file($tmp_name2, $path2);
        
        $phtdt2 = $_POST["phtdt2"];

        $tmp_name3 = $_FILES["pht3"]["tmp_name3"];
        $path3 = "uploads/users/" . $_FILES["pht3"]["tmp_name3"];
        move_uploaded_file($tmp_name3, $path3);

        $tmp_name2 = $_FILES["pht4"]["tmp_name4"];
        $path4 = "uploads/users/" . $_FILES["pht4"]["tmp_name4"];
        move_uploaded_file($tmp_name4, $path4);
        
        $tmp_name5 = $_FILES["pht5"]["tmp_name5"];
        $path5 = "uploads/users/" . $_FILES["pht5"]["tmp_name5"];
        move_uploaded_file($tmp_name5, $path5);
        
        $tmp_name6 = $_FILES["pht6"]["tmp_name6"];
        $path6 = "uploads/users/" . $_FILES["pht6"]["tmp_name6"];
        move_uploaded_file($tmp_name6, $path6);
    ...
    {
        $id=($_GET["edit-id"]);
        $eddata=$this->editdata('add_deal','add_team','add_gallary','add_slider','add_footer',$id);
    }
        ...
        if (isset($_SERVER["PATH_INFO"])) {
            switch ($_SERVER["PATH_INFO"]) {
                ...
                case '/editcontactus':
                    require_once("index.php");
                    require_once("header.php");
                    require_once("editcontactus.php");
                    require_once("footer.php");
                    break;
