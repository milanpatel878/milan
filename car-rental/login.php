...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-8 mt-5">
      <form method="post" role="form">
        ...
        <div class="form-group col-md-8 mt-2">
          <button type="submit" name="log" class="btn btn-lg btn-primary">Sign In</button> &nbsp;
    ...
    <div class="col-md-4 ">
      ...
      <img src="<?php echo $baseurl; ?>/images/user.gif" style="margin: 0px; padding: 0px;" class="img-fluid">
    </div>
  </div>
